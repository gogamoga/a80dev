...
#endif
#ifdef SUNXI_S_TWI1
#define SUNXI_S_TWI1_MEM_BASE		SUNXI_R_TWI1_PBASE
#define SUNXI_S_TWI1_MEM_RANGE		0x400
#define SUNXI_S_TWI1_MEM_START		(SUNXI_S_TWI1_MEM_BASE)
#define SUNXI_S_TWI1_MEM_END		(SUNXI_S_TWI1_MEM_START + SUNXI_S_TWI1_MEM_RANGE - 1)
#define SUNXI_S_TWI1_IRQ	    	SUNXI_IRQ_R_TWI1
#endif
