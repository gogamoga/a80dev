...
#ifdef SUNXI_S_TWI1
	{
		sunxi_twi_resources[(SUNXI_TWI_NUM - 1) * SUNXI_TWI_RES_NUM].start = SUNXI_S_TWI1_MEM_START;
		sunxi_twi_resources[(SUNXI_TWI_NUM - 1) * SUNXI_TWI_RES_NUM].end   = SUNXI_S_TWI1_MEM_END;
		sunxi_twi_resources[(SUNXI_TWI_NUM - 1) * SUNXI_TWI_RES_NUM].flags = IORESOURCE_MEM;

		sunxi_twi_resources[(SUNXI_TWI_NUM - 1) * SUNXI_TWI_RES_NUM + 1].start = SUNXI_S_TWI1_IRQ;
		sunxi_twi_resources[(SUNXI_TWI_NUM - 1) * SUNXI_TWI_RES_NUM + 1].end   = SUNXI_S_TWI1_IRQ;
